...
const EditPatientDetails = () => {
    ...
    const getUserData = async (e) => {
        try {
            ...
            const details = await axios.get(`https://doctorsapp-backend-3.onrender.com/getuserdetails`, {
                headers: {
                    'Authorization': `${token}`
                }
            });
    ...
    const handleUpdate = async () => {
        ...
        try {
            ...
            const token = localStorage.getItem('authToken');
            const response = await axios.patch(`https://doctorsapp-backend-3.onrender.com/updateuserdetails`, profileData, {
                headers: {
                    'Authorization': `${token}`
                }
            });
    ...
    return (
        <div className='editpatientdetails'>
            <div className='editpatientimage'><img className='editpatientprofileimage' src={`https://doctorsapp-backend-3.onrender.com/` + patientDetails.profile_image} alt='patient'></img></div>
