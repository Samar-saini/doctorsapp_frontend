...
const PatientDetails = () => {
    ...
    const getUserData = async (e) => {
        try {
            ...
            const details = await axios.get(`https://doctorsapp-backend-3.onrender.com/getuserdetails`, { headers: { 'Authorization': `${token}` } });
    ...
    return (
        <div className='patientdetails'>
            <div className='patientimage'><img className='patientprofileimage' src={`https://doctorsapp-backend-3.onrender.com/` + patientDetails.profile_image} alt='patient'></img></div>
