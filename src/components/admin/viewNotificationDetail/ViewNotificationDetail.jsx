...
const ViewNotificationDetail = () => {
    ...
    const getUserData = async (e) => {
        try {
            ...
            const details = await axios.get(`https://doctorsapp-backend-3.onrender.com/getdoctordetails`, {params: {id: id}, headers: { 'Authorization': `${token}`}});
            //console.log(details);
    ...
    const approveRequest = async () => {
        ...
        try {
            const token = localStorage.getItem('authToken');
            const response = await axios.patch(`https://doctorsapp-backend-3.onrender.com/approveDoctor`, notificationDetails, { headers: { 'Authorization': `${token}`}});
            alert("approved");
    ...
    return (
        <div className='notificationdetails'>
            <div className='notificationimage'><img className='notificationprofileimage' src={`https://doctorsapp-backend-3.onrender.com/` + notificationDetails.profile_image} alt='notification'></img></div>
