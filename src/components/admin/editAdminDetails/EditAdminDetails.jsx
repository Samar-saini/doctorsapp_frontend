...
const EditAdminDetails = () => {
    ...
    return (
        <div className='editadmindetails'>
            <div className='editadminimage'><img className='editadminprofileimage' src={`https://doctorsapp-backend-3.onrender.com/` + adminDetails.profile_image} alt='admin'></img></div>
