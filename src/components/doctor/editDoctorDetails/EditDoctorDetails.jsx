...
const EditDoctorDetails = () => {
    ...
    return (
        <div className='editdoctordetails'>
            <div className='editdoctorimage'><img className='editdoctorprofileimage' src={`https://doctorsapp-backend-3.onrender.com/`+doctorDetails.profile_image} alt='doctor'></img></div>
