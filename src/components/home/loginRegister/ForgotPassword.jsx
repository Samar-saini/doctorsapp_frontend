...
const ForgotPassword = () => {
    ...
    const requestOtp = async (e) => {
        ...
        setOtpFlag(true);
        axios.post("https://doctorsapp-backend-3.onrender.com/sendOtppassword", { email: forgotPasswordData.email })
            .then((response) => {
                //setOtpFlag(true);
    ...
    const submitData = async (e) => {
        ...
        axios.post("https://doctorsapp-backend-3.onrender.com/changePassword", { email: forgotPasswordData.email, password: forgotPasswordData.password, otp: forgotPasswordData.otp })
            .then((response) => {
