...
const Login = () => {
  ...
  const requestOtp = async (e) => {
    ...
    setOtpFlag(true);
    axios.post("https://doctorsapp-backend-3.onrender.com/sendotp", { email: registrationData.email })
      .then((response) => {
        setOtpFlag(true);
  ...
  const loginUsingPassword = async (e) => {
    ...
    axios.post("https://doctorsapp-backend-3.onrender.com/login", registrationData).
      then(response => {
  ...
  const loginUsingOTP = async (e) => {
    ...
    axios.post("https://doctorsapp-backend-3.onrender.com/verifyOtp", registrationData)
      .then((response) => {
        if (response.data.userData.role === "admin") {
          navigate(`/admin/admindetails`);
        }
